...
window.addEventListener("DOMContentLoaded", function () {
    ...
    closeIconBtn.addEventListener("click", function () {
        sideBar.classList.remove("activeMob");
    ...
    const newsData = [{
            ...
            paragraph: `In 2023, Google Summer of Code brought 966 new contributors into open source software development to work with open source organizations on a 12+ week project. We had 168 participating open source organizations with mentors and contributors from over 75 countries this year. For 19 years, Google Summer of Code has thrived due to the enthusiasm of our open source communities and the 19k+`,
        },
        {
